      ...
      <footer className='p-10 container mx-auto'>
        <div className='grid grid-cols-1 lg:grid-cols-2  gap-5'>
          <div className='mb-6 md:mb-0 flex flex-col items-center lg:justify-start lg:items-start'>
            ...
            <p className='w-3/4'>
              Every problem have a solution.In daily life problems, we want to
              solves your problem.We want to give you some services for your
              daily life problems. We have all experience worker.
            </p>
          </div>
